...
using MyCode.Viewports.TwitterApi.Exceptions;
using MyCode.Viewports.TwitterApi.Results.RuleObjects;
using MyCode.Viewports.TwitterApi.Services.AuthenticateObjects;
using MyCode.Viewports.TwitterApi.Services.Extensions;

namespace MyCode.Viewports.TwitterApi.Services.RuleObjects
{
    /// <summary>
